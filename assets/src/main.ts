...
const newAuthor = document.getElementById("newAuthor") as HTMLInputElement;
const newCategory = document.getElementById("newCategory") as HTMLInputElement;
const newType = document.getElementById("newType") as HTMLSelectElement;
...
addBtn.addEventListener("click", () => {
    if (!newTitle.value || !newAuthor.value || !newCategory.value) return ;
